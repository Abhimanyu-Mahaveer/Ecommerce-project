...
const CheckoutPage = () => {
  ...
  return (
    <>
      ...
      {currentOrder && <Navigate to={`/order-success/${currentOrder}`} replace={true}></Navigate>}
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <form className="bg-white px-8 py-10 mt-10 mb-10" noValidate onSubmit={handleSubmit((data)=> {
              dispatch(
                ...
                <div className="border-b border-gray-900/10 pb-12">
                  ...
                  <ul role="list">
                    {user.addresses.map((address,index) => (
                      <li
                        key={index}
                        className="flex justify-between gap-x-6 py-5 px-5 border-solid border-2"
                      >
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-10 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
              <div className="border-t border-gray-200 mx-auto py-8 max-w-7xl px-0 sm:px-0 lg:px-8">
                <h1 class="text-4xl font-bold tracking-tight text-gray-900 my-3">
                  Cart
                </h1>
                      ...
                      <li key={item.id} className="flex py-6">
                        ...
                        <div className="ml-4 flex flex-1 flex-col">
                          ...
                          <div className="flex flex-1 items-end justify-between text-sm">
                            <div className="text-gray-500 mr">
                              <label
                                htmlFor="quantity"
